...
import officialLogo from '../../public/icons/official-logo.png';

export default function officialDraft() {
  return (
    <div className="flex flex-col justify-center w-full pt-[90px] laptop:pt-[100px] mb-20 h-fit items-center px-4 tablet:px-10 laptop:px-20">
      <div className="w-full flex flex-col gap-10 rounded-lg max-w-[1000px] bg-dark2 px-4  tablet:px-10 py-10  laptop:px-20 laptop:pt-20 laptop:pb-14">
        <div className="flex items-center gap-6 border-b border-dark3 pb-6 px-6">
          <div className="h-10 w-10">
            <Image src={officialLogo} alt="official logo" />
          </div>
